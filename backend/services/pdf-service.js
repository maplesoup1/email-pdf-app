...
// Merges the email PDF with attachment PDFs and adds a footer to the merged document.
    ...
    // Generates a safe file name for the PDF based on subject, message ID, and whether it's merged.
